...
def generate_index(summaries, docs_dir):
    ...
    for s in summaries:
        ...
        <div class="card">
          ...
          <p class="tasks-count">{completed}/{total} tasks complete</p>
...
<style>
  * {{ margin: 0; padding: 0; box-sizing: border-box; }}
  ...
  .card {{ background: #1a1d27; border-radius: 12px; padding: 28px; border: 1px solid #2a2d3a; display: flex; flex-direction: column; align-items: center; gap: 12px; }}
...
def generate_project_page(summary, docs_dir):
    ...
    <section class="section">
      ...
      <div class="table-wrap">
        <table>
          <thead><tr><th>Floor</th><th>Progress</th><th>Tasks</th><th>%</th><th>Last Activity</th><th></th></tr></thead>
...
<style>
  * {{ margin: 0; padding: 0; box-sizing: border-box; }}
  ...
  .bar-wrap {{ width: 140px; height: 8px; background: #2a2d3a; border-radius: 4px; overflow: hidden; }}
